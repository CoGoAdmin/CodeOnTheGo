...
import org.appdevforall.codeonthego.events.FileContextMenuItemClickEvent
...
class FileTreeActionHandler : BaseEventHandler() {
  ...
  private fun createFileOptionsFragment(
    ...
    file: File
  ): org.appdevforall.codeonthego.fragments.sheets.OptionsListFragment {
    val fragment = org.appdevforall.codeonthego.fragments.sheets.OptionsListFragment()
