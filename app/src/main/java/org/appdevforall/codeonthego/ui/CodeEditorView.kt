...
import org.appdevforall.codeonthego.editor.databinding.LayoutCodeEditorBinding
...
class CodeEditorView(
  ...
  private fun postRead(file: File) {
    ...
    if (org.appdevforall.codeonthego.lsp.IDELanguageClientImpl.isInitialized()) {
      binding.editor.setLanguageClient(org.appdevforall.codeonthego.lsp.IDELanguageClientImpl.getInstance())
    }
