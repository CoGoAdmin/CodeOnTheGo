...
import org.appdevforall.codeonthego.services.builder.ToolingServerRunner.OnServerStartListener
...
class GradleBuildService : Service(), BuildService, IToolingApiClient,
  ...
  private fun onPrepareBuildRequest() {
    ...
    if (isBuildInProgress) {
      logBuildInProgress()
      throw org.appdevforall.codeonthego.services.builder.BuildInProgressException()
    }
    isBuildInProgress = true
  }

  @Throws(org.appdevforall.codeonthego.services.ToolingServerNotStartedException::class)
  private fun checkServerStarted() {
    if (!isToolingServerStarted()) {
      throw org.appdevforall.codeonthego.services.ToolingServerNotStartedException()
    }
  }
