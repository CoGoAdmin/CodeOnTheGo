...
import org.appdevforall.codeonthego.databinding.LayoutCreateFileJavaBinding
...
class NewFileAction(context: Context, override val order: Int) :
  ...
  private fun doCreateJavaFile(
    ...
    val pkgName = org.appdevforall.codeonthego.utils.ProjectWriter.getPackageName(file)
      ...
      when (id) {
        binding.typeClass.id ->
          createFile(
            ...
            file,
            javaName,
            org.appdevforall.codeonthego.utils.ProjectWriter.createJavaClass(pkgName, className)
          )
        ...
        binding.typeInterface.id ->
          createFile(
            ...
            file,
            javaName,
            org.appdevforall.codeonthego.utils.ProjectWriter.createJavaInterface(pkgName, className)
          )
        ...
        binding.typeEnum.id ->
          createFile(
            ...
            file,
            javaName,
            org.appdevforall.codeonthego.utils.ProjectWriter.createJavaEnum(pkgName, className)
          )
        ...
        binding.typeActivity.id ->
          createFile(
            ...
            file,
            javaName,
            org.appdevforall.codeonthego.utils.ProjectWriter.createActivity(pkgName, className)
          )
  ...
  private fun createLayoutRes(context: Context, node: TreeNode?, file: File) {
    createNewFileWithContent(
      ...
      org.appdevforall.codeonthego.utils.ProjectWriter.createLayout(),
      ".xml"
    )
  }
  ...
  private fun createAutoLayout(
    ...
    val layoutName = org.appdevforall.codeonthego.utils.ProjectWriter.createLayoutName(fileName.replace(".java", ".xml"))
    ...
    if (!FileIOUtils.writeFileFromString(newFileLayout, org.appdevforall.codeonthego.utils.ProjectWriter.createLayout())) {
  ...
  private fun createMenuRes(context: Context, node: TreeNode?, file: File) {
    createNewFileWithContent(
      ...
      node,
      Environment.mkdirIfNotExits(file),
      org.appdevforall.codeonthego.utils.ProjectWriter.createMenu(),
      ".xml"
    )
  }
  ...
  private fun createDrawableRes(context: Context, node: TreeNode?, file: File) {
    createNewFileWithContent(
      ...
      node,
      Environment.mkdirIfNotExits(file),
      org.appdevforall.codeonthego.utils.ProjectWriter.createDrawable(),
      ".xml"
    )
  }
  ...
  private fun createFile(
    ...
    if (node != null) {
      ...
      newNode.viewHolder = org.appdevforall.codeonthego.adapters.viewholders.FileTreeViewHolder(context)
