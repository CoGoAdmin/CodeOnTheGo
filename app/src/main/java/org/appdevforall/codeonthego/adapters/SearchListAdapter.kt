...
import org.appdevforall.codeonthego.adapters.SearchListAdapter.VH
import org.appdevforall.codeonthego.databinding.LayoutSearchResultGroupBinding
import org.appdevforall.codeonthego.databinding.LayoutSearchResultItemBinding
import org.appdevforall.codeonthego.models.FileExtension
...
class SearchListAdapter(
  private val results: Map<File, List<org.appdevforall.codeonthego.models.SearchResult>?>,
  private val onFileClick: (File) -> Unit,
  private val onMatchClick: (org.appdevforall.codeonthego.models.SearchResult) -> Unit,
  private val keys: List<File>
) : Adapter<VH>() {

  constructor(
    results: Map<File, List<org.appdevforall.codeonthego.models.SearchResult>?>,
    onFileClick: (File) -> Unit,
    onMatchClick: (org.appdevforall.codeonthego.models.SearchResult) -> Unit
  ...
  inner class ChildAdapter(val matches: List<org.appdevforall.codeonthego.models.SearchResult>) : Adapter<ChildVH>() {
