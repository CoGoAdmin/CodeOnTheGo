...
import org.appdevforall.codeonthego.R.string
import org.appdevforall.codeonthego.adapters.SearchListAdapter
import org.appdevforall.codeonthego.app.EdgeToEdgeIDEActivity
import org.appdevforall.codeonthego.databinding.ActivityEditorBinding
import org.appdevforall.codeonthego.databinding.ContentEditorBinding
import org.appdevforall.codeonthego.databinding.LayoutDiagnosticInfoBinding
import org.appdevforall.codeonthego.events.InstallationResultEvent
import org.appdevforall.codeonthego.fragments.SearchResultFragment
import org.appdevforall.codeonthego.fragments.sidebar.EditorSidebarFragment
import org.appdevforall.codeonthego.fragments.sidebar.FileTreeFragment
import org.appdevforall.codeonthego.handlers.EditorActivityLifecyclerObserver
import org.appdevforall.codeonthego.handlers.LspHandler.registerLanguageServers
import org.appdevforall.codeonthego.models.OpenedFile
import org.appdevforall.codeonthego.ui.CodeEditorView
import org.appdevforall.codeonthego.ui.SwipeRevealLayout
import org.appdevforall.codeonthego.utils.ActionMenuUtils.createMenu
import org.appdevforall.codeonthego.utils.ApkInstallationSessionCallback
import org.appdevforall.codeonthego.utils.InstallationResultHandler.onResult
import org.appdevforall.codeonthego.utils.IntentUtils
import org.appdevforall.codeonthego.utils.MemoryUsageWatcher
...
abstract class BaseEditorActivity : EdgeToEdgeIDEActivity(), TabLayout.OnTabSelectedListener,
    org.appdevforall.codeonthego.interfaces.DiagnosticClickListener {
  ...
  override fun onGroupClick(group: org.appdevforall.codeonthego.models.DiagnosticGroup?) {
  ...
  open fun handleSearchResults(map: Map<File, List<org.appdevforall.codeonthego.models.SearchResult>>?) {
  ...
  open fun setDiagnosticsAdapter(adapter: org.appdevforall.codeonthego.adapters.DiagnosticsAdapter) {
