 ...
 * Why do we need to copy this, when ToolsManager still uses data/common foler? It's a root source folder for executable assets.
 * Why does it need a generated folder to hold dependencies? It's a static lib repo that is not cleaned by any cache/storage cleans.
 *
